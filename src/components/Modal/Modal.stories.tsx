...
const ModalStoryChanges = (args: ModalProps) => {
  const [isOpen, setIsOpen] = useState(args.isOpen)
  return (
    <>
      <Button onClick={() => setIsOpen(true)}>Abrir Modal</Button>
      <Modal {...args} isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <Typography className="font-bold">Your changes will be lost</Typography>
        <div className=" flex flex-col gap-3">
...
const ModalStoryConfirmDelete = (args: ModalProps) => {
  const [isOpen, setIsOpen] = useState(args.isOpen)
  return (
    <>
      <Button onClick={() => setIsOpen(true)}>Abrir Modal</Button>
      <Modal {...args} isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <Typography className="font-bold">All data will be lost</Typography>
        <div className=" flex flex-col gap-3">
          <Button
            variant="primary"
...
export const ModalChanges: Story = {
  args: {
    isOpen: false,
    title: 'Modal Changes',
  },
  render: (args: ModalProps) => {
    return <ModalStoryChanges {...args} />
  },
}

export const ModalConfirmDelete: Story = {
  args: {
    isOpen: false,
    title: 'Modal Confirm Delete',
  },
  render: (args: ModalProps) => {
    return <ModalStoryConfirmDelete {...args} />
  },
}
